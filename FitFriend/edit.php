...
<html lang="en">
    ...
    <div class="container">
        ...
        <form class="form-horizontal" action="" method="post" >
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="txtCallories">Calories</label>
            <div class="col-sm-10">
                  <input type="text" class="form-control calsSpin" id="txtCallories" name="Callories" placeholder="Calories in this meal"  value="<?=$meal['Callories']?>">
            </div>
          </div>
          <div class="form-group">
