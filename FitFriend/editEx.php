...
<html lang="en">
    ...
    <div class="container">
        ...
        <div class="page-header">
          <h1>Exercise log <small>Record your daily Exercise</small></h1>
        </div>
        <form class="form-horizontal" action="" method="post" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="txtName" name="Name" placeholder="Exercise Name" value="<?=$workout['Name']?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="txtCallories">Calories Burned</label>
            <div class="col-sm-10">
                  <input type="text" class="form-control calsSpin" id="txtCallories" name="Callories" placeholder="Calories Burned"  value="<?=$workout['Callories']?>">
            </div>
          </div>
          <div class="form-group">
